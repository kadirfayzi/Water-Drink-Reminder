...
class _SleekCircularSliderState extends State<SleekCircularSlider>
  ...
  Widget build(BuildContext context) {
    /// _setupPainter execution when _painter is null or appearance has changed.
    ...
    return RawGestureDetector(
        ...
        child: _buildRotatingPainter(
            rotation: _rotation, size: Size(widget.appearance.size, widget.appearance.size)));
  }
  ...
  Widget _buildPainter({required Size size}) => CustomPaint(
        painter: _painter,
        child: SizedBox(
          width: size.width,
          height: size.height,
  ...
  void _handlePan(Offset details, bool isPanEnd) {
    ...
    final double touchWidth =
        widget.appearance.progressBarWidth >= 25.0 ? widget.appearance.progressBarWidth : 25.0;
